...
ECHO/ & ECHO Process Complete.. & ECHO/ & ECHO ISO Updated & ECHO/ & ECHO "Win1!VERSION!_DE_x64.iso" is located in the same folder as this script. ;^) & ECHO/
CALL :XBUTTON true
PAUSE
ENDLOCAL
EXIT /b
...
IF EXIST Win1%VERSION%_DE_x64.iso (
FORFILES /d -3 /m "Win1%VERSION%_Eng_x64.iso" >NUL 2>NUL && (
DEL "%TempDL%\Win1%VERSION%_DE_x64.iso" /F /Q>nul
