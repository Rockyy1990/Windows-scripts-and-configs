...
echo -- amd-ryzen-chipset firefox 7zip steam vcredist140 vlc aimp discord thunderbird dotnet notepadplusplus
taskkill /f /im explorer.exe && start explorer.exe && start cmd /k "choco install amd-ryzen-chipset firefox 7zip steam vcredist140 vlc aimp discord thunderbird dotnet notepadplusplus -y --force --ignorepackageexitcodes"
:: Pause the script
pause
