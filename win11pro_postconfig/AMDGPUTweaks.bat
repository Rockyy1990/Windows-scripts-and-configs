...
echo # AMD GPU Tweaks
echo # Works on AMD/ATI GPUs ONLY

echo # IMPROVE LATENCY AT THE COST OF LITTLE LESS FPS
...
rem # RECOMMENDED TO DISABLE ONBOARD INTEGRATED GPU IN BIOS DEVICE MANAGER
